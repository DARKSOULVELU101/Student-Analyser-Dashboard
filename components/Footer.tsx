...
export default function Footer() {
  return (
    <footer className="border-t border-dark-800/50 py-12 px-4 sm:px-6 lg:px-8 mt-16">
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          ...
          <div className="col-span-1 md:col-span-2">
            <div className="flex items-center gap-3 mb-4">
              ...
              <div>
                <h3 className="text-lg font-bold text-white">Student Analyser</h3>
          ...
          <div>
            ...
            <ul className="space-y-2">
              {['Dashboard', 'Upload Data', 'Analytics', 'AI Assistant'].map((link) => (
                <li key={link}>
                  <a href="#" className="text-sm text-dark-400 hover:text-primary-400 transition-colors cursor-pointer">
                    {link}
                  </a>
                </li>
              ))}
        ...
        <div className="border-t border-dark-800/50 pt-8 flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <a
            ...
            className="flex items-center gap-2 text-sm text-dark-400 hover:text-primary-400 transition-colors cursor-pointer"
          >
            Visit SKEC Website
